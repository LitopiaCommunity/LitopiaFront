...
export class ArchivesComponent {
  ...
  seasons: SeasonDownload[] = [
    {
      ...
      downloadUrl: '#',
      description:
        'Le serveur originel qui a donné naissance à la communauté Litopia (2015)',
      available: false,
      type: 'survival',
      year: 2015,
    },
    {
      ...
      downloadUrl: '#',
      description:
        'La première saison officielle de Litopia en monde amplifié (Janvier 2016)',
      available: false,
      type: 'survival',
      year: 2016,
    },
    {
      ...
      description:
        'Générateur de monde vanilla spécial OTG avec plugins par Sekori (Août 2017)',
      available: true,
      type: 'survival',
      year: 2017,
    },
    {
      ...
      description:
        'La saison 3 sur le thème pirate, avec nouveau discord et nouveau site (Juillet 2018)',
      available: true,
      type: 'survival',
      year: 2018,
    },
    {
      ...
      downloadUrl: '#',
      description:
        'Saison mystérieuse et confidentielle élue meilleure saison (2019)',
      available: false,
      type: 'survival',
      year: 2019,
    },
    {
      ...
      downloadUrl: '#',
      description:
        'Une saison festive où Noël durait tous les jours ! (Décembre 2019)',
      available: false,
      type: 'survival',
      year: 2019,
    },
    {
      ...
      description:
        'La saison du confinement, quand tout le monde était là (Mars 2020)',
      available: true,
      type: 'survival',
      year: 2020,
    },
    {
      ...
      description:
        'Une vraie saison comme à la bonne époque, absolument géniale (Juillet 2020)',
      available: true,
      type: 'survival',
      year: 2020,
    },
    {
      ...
      downloadUrl: '#',
      description:
        'Saison mod pack Better Minecraft en attendant la 1.18 (Juin 2021)',
      available: false,
      type: 'survival',
      year: 2021,
    },
    {
      ...
      description:
        'Rivalité entre Licorp et Union Litopiste. Guerre froide dans les montagnes (Décembre 2021)',
      available: true,
      type: 'survival',
      year: 2021,
    },
    {
      ...
      description:
        'Génération incroyable, propagande de waifus et apogée de la Likorp (Septembre 2022)',
      available: true,
      type: 'survival',
      year: 2022,
    },
    {
      ...
      downloadUrl: '#',
      description:
        'Version complète avec spawn reconstruit et immense ville japonaise (Archive en cours)',
      available: false,
      type: 'survival',
      year: 2023,
    },
    {
      ...
      description:
        "Saison de la simplicité et de la liberté. Seed choisie par vote, world border évolutive. Premiers signes d'essoufflement (Juin 2024)",
      available: true,
      type: 'survival',
      year: 2024,
    },
    {
      ...
      description:
        'Monde créatif où les Litopiens laissaient libre cours à leur imagination (2019-2021)',
      available: true,
      type: 'creative',
      year: 2021,
    },
    {
      ...
      description:
        'Monde créatif nouvelle génération avec les nouveaux biomes (2021-2023)',
      available: true,
      type: 'creative',
      year: 2023,
    },
    {
      ...
      description:
        'Monde créatif des dernières saison un peut moins actif que les autres (2023-2026)',
      available: true,
      type: 'creative',
      year: 2026,
    },
  ...
  constructor(private seo: SeoService) {
    this.seo.generateTags({
      ...
      description:
        'Téléchargez les maps historiques de Litopia (2015-2026). 8 maps disponibles + 2 mondes créatifs.',
    });
  }
